...
export default function KycPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
       await toast.promise(api.post("/users/kyc",{
    ...
    <div className="w-full space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-slate-600">
          Help us verify your identity and address to keep your account secure.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="p-5 flex items-start gap-3">
          ...
          <p className="text-sm text-slate-700">
            Need assistance? Call <b>020 8002 8761</b> / <b>016 1563 0904</b> or
            email <b>hello@monefi.co.uk</b>
          </p>
        </div>
      </div>
            ...
            <div className="space-y-3">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-slate-500">
                  Must show full name & current address, dated within the last 3
                  months.
                </p>
              </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="text-sm font-medium">
              {current ? "File upload successfull" : "Upload document"}
            </div>
            <p className="text-xs text-slate-500">
