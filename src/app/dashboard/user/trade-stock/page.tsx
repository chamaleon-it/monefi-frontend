...
export default function TradeStockPage() {
  ...
  return (
    <div className='flex flex-col gap-2.5 pointer-events-none'>
        ...
        <select name="" id="" className='w-[400px] h-14 px-5 rounded-xl border-2 border-bakerjonesholdings-off-pink bg-bakerjonesholdings-off-pink  pointer-events-auto font-semibold' onChange={e=>setSymbol(e.target.value)} value={symbol}>
