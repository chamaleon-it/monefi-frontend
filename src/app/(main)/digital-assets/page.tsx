...
import { ArrowRight, CheckCircle2, Shield, Lock, Code2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-corporate-white font-sans text-slate-800">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 bg-[#082348] overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1621416894569-0f39ed31d247?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-white/70 text-[16px] lg:text-[18px] max-w-2xl mx-auto leading-relaxed">
            Institutional-grade exposure to the future of decentralized finance, digital infrastructure, and blockchain technology.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-[#082348] mb-6">
                Pioneering the Next <span className="text-corporate-gold italic font-normal">Financial Frontier.</span>
              </h2>
              <p className="text-[16px] text-slate-500 mb-8 leading-relaxed">
                As the financial landscape evolves, our Digital Assets division provides secure, regulated access to cryptocurrencies, tokenized assets, and decentralized protocols. We employ institutional custody solutions and rigorous due diligence to mitigate technological risks while capturing early-stage upside.
              </p>
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl relative z-10">
                <img src="https://images.unsplash.com/photo-1621416894569-0f39ed31d247?q=80&w=2000&auto=format&fit=crop" alt="Digital Assets" className="w-full h-full object-cover" />
              </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-500 text-[16px] leading-relaxed">
              We employ a rigorous, tech-forward approach to safely navigate the complexities of decentralized finance and Web3 infrastructure.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-slate-100 hover:-translate-y-1 transition-transform">
              ...
              <h3 className="text-xl font-bold text-[#082348] mb-3">Institutional Custody</h3>
              <p className="text-slate-500 text-[15px] leading-relaxed">We utilize multi-sig wallets, cold storage, and regulated custodial partners to ensure bank-grade security for all digital assets.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-slate-100 hover:-translate-y-1 transition-transform">
              <div className="w-12 h-12 rounded-xl bg-[#082348]/5 flex items-center justify-center mb-6 text-[#082348]">
                <Code2 className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold text-[#082348] mb-3">Smart Contract Auditing</h3>
              <p className="text-slate-500 text-[15px] leading-relaxed">Before deploying capital, our technical analysts perform deep code-level reviews and on-chain forensics to mitigate protocol risk.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-slate-100 hover:-translate-y-1 transition-transform">
              <div className="w-12 h-12 rounded-xl bg-[#082348]/5 flex items-center justify-center mb-6 text-[#082348]">
                <Shield className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold text-[#082348] mb-3">Regulatory Compliance</h3>
              <p className="text-slate-500 text-[15px] leading-relaxed">We strictly adhere to AML/KYC frameworks and work closely with global regulators to ensure fully compliant blockchain investments.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 divide-y sm:divide-y-0 sm:divide-x divide-white/10">
            <div className="pt-8 sm:pt-0">
              <div className="text-5xl font-serif font-bold text-corporate-gold mb-3">180%</div>
              <div className="text-[13px] text-white/60 font-medium uppercase tracking-[0.15em]">Historical 3-Year Return</div>
            </div>
            <div className="pt-8 sm:pt-0">
              <div className="text-5xl font-serif font-bold text-corporate-gold mb-3">100+</div>
              <div className="text-[13px] text-white/60 font-medium uppercase tracking-[0.15em]">Protocols Analyzed</div>
            </div>
            <div className="pt-8 sm:pt-0">
              <div className="text-5xl font-serif font-bold text-corporate-gold mb-3">$1.5B</div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
          <div className="bg-corporate-gold/10 rounded-[2rem] p-10 lg:p-16 border border-corporate-gold/20 flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="max-w-2xl text-center lg:text-left">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-[#082348] mb-4">Ready to optimize your digital asset exposure?</h2>
              <p className="text-[#082348]/70 text-[16px] leading-relaxed font-medium">Speak with our investment committee to learn how our Digital Asset strategies can align with your institutional mandate.</p>
            </div>
