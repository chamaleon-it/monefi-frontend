  ...
  const sections = [
    {
      ...
      icon: <Landmark className="w-10 h-10 text-bakerjonesholdings-pink" />,
    ...
    },
    {
      ...
      icon: <HeartHandshake className="w-10 h-10 text-bakerjonesholdings-pink" />,
      ...
      <div className="max-w-6xl mx-auto space-y-16">
        {sections.map((section, idx) => (
          <motion.div
            ...
            className="bg-bakerjonesholdings-off-pink text-bakerjonesholdings-black rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row"
          >
            <Image
            width={576}
            height={406}
