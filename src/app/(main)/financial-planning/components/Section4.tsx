...
export default function Section4() {
  const sections = [
    {
      ...
      icon: <Landmark className="w-10 h-10 text-gray-900" />,
    ...
    },
    {
      ...
      icon: <HeartHandshake className="w-10 h-10 text-gray-900" />,
  ...
  return (
    <section className="bg-bakerjonesholdings-black py-16 px-4 md:px-10">
      <div className="max-w-6xl mx-auto space-y-16">
        {sections.map((section, idx) => (
          <motion.div
            ...
            className="bg-bakerjonesholdings-off-pink text-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row"
          >
            <Image
              width={576}
              height={406}
            ...
            />
            <div className="p-8 flex-1 flex flex-col justify-center text-gray-700">
