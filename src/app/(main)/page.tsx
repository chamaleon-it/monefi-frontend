      ...
      <section className="bg-[#082348] py-10 lg:py-16">
        <ScrollAnimation className="max-w-[1400px] mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/application-form" className="w-full sm:w-auto inline-flex items-center justify-center px-10 py-4 bg-corporate-gold text-[#082348] hover:bg-yellow-500 rounded-full font-bold text-[15px] transition-all">
              Open Account
            </Link>
