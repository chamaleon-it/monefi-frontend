...
export default function StepTrustTaxInfo({ formData, onNext, onBack }: StepProps) {
  return (
    <div className="max-w-4xl mx-auto px-5 sm:px-8 lg:px-10 py-10 sm:py-14 font-inter w-full">
      <div className="mb-10">
        ...
        <h1 className="text-[1.875rem] sm:text-[2.125rem] font-semibold text-slate-900 tracking-tight leading-tight mb-2">Trust Tax Info</h1>
        <p className="text-[15px] text-slate-600 leading-relaxed">Provide tax-related details for the trust.</p>
      </div>
      <div className="bg-white rounded-2xl border border-slate-200 shadow-[0_2px_20px_rgba(0,0,0,0.06)] p-8 sm:p-10">
        <div className="flex items-start gap-4 mb-8 pb-6 border-b border-slate-100">
          ...
          <div>
            <p className="text-[17px] font-semibold text-slate-900">Tax Information</p>
            <p className="text-[13px] text-slate-500 mt-1">FATCA and CRS classifications</p>
          </div>
        </div>
        <p className="text-slate-500 text-[14px]">Tax info form (Placeholder)</p>
      </div>
