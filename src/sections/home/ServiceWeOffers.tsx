  ...
  return (
    <section className='bg-white'>
        <div className="max-w-[95%] lg:max-w-[83%] mx-auto mb-24">
            ...
            <h2 className='font-poppins font-bold text-5xl lg:text-6xl mac:text-8xl'>Service we offer</h2>
            </div>
    ...
    return (
        <div className={`aspect-[79/67] bg-monefi-${bg} rounded-4xl relative`}>
            <div className="absolute bottom-5 left-5 text-white space-y-5">
                <p className='font-poppins font-bold text-lg lg:text-2xl mac:text-4xl'>{title}</p>
