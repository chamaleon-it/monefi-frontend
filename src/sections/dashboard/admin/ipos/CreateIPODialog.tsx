...
export default function CreateIPODialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <button className="px-5 py-2.5 bg-bakerjonesholdings-pink hover:bg-bakerjonesholdings-pink/90 text-white rounded-xl shadow-sm transition-all font-medium text-sm">
          Create IPO
        </button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[650px] p-0 max-h-[85vh] overflow-hidden bg-white text-bakerjonesholdings-black rounded-2xl shadow-2xl border-0 flex flex-col">
        <DialogHeader className="px-6 py-5 border-b border-gray-100 bg-gray-50/30 shrink-0">
          <DialogTitle className="text-xl font-bold">Create IPO</DialogTitle>
          <DialogDescription className="text-gray-500 mt-1">
            Add a new IPO offering to the platform.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="flex items-center space-x-3 pt-6">
                  ...
                  />
                  <label htmlFor="isPublic" className="text-sm font-medium text-gray-700 select-none cursor-pointer">
